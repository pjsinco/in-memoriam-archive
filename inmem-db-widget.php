...
<form name="school_choice" action="<?php echo get_bloginfo('wpurl') . '/inmem-db3.php'; ?>" method="get">
...
<form name="year_choice" action="<?php echo get_bloginfo('wpurl') . '/inmem-db3.php'; ?>" method="get">
	<select name="year">
...
<form name="state_choice" action="<?php echo get_bloginfo('wpurl') . '/inmem-db3.php'; ?>" method="get">
	<select name="state">
